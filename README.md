# PasswordVault
This is the project I created during the course "Modern Java technologies" in FMI Sofia. It is a client-server password manager with console interface and it supports the following functionalities : 

package bg.sofia.uni.fmi.mjt.password.vault.server.password.safety.checker;

import bg.sofia.uni.fmi.mjt.password.vault.server.MyConfig;
...
import bg.sofia.uni.fmi.mjt.password.vault.server.password.hasher.PasswordHasher;
...
public class PasswordSafetyChecker {
    ...
    private static final String AUTHENTICATION_HEADER_VALUE = "basic " + MyConfig.ENZOIC_AUTH_KEY;
            // "basic ODUyYTJmYTY3YmNkNGY5ZjliZTUwNDE4YWE3ZTE1NTI6cmJYI3kkNzJHeDhhekE4cGpZX1FISnIxcm16N0hAJFQ";

package bg.sofia.uni.fmi.mjt.password.vault.server.password.vault;

import bg.sofia.uni.fmi.mjt.password.vault.server.credential.CredentialIdentifier;
import bg.sofia.uni.fmi.mjt.password.vault.server.dto.CredentialDTO;
...
import bg.sofia.uni.fmi.mjt.password.vault.server.user.credentials.UserCredentials;
...
public class PasswordVault {
    ...
    public PasswordVault(Path credentialsFile) {
